//API7TP08 JOB (ACCT#),'ALEXIS',MSGCLASS=H,REGION=4M,                   00010001
...
//COBOL.SYSIN  DD DSN=API7.SOURCE.COBOL(TP08),DISP=SHR                  00070000
//COBOL.SYSLIB DD DSN=CEE.SCEESAMP,DISP=SHR                             00080000
//*                                                                     00090000
//*  ETAPE DE LINKEDIT                                                  00100000
//*                                                                     00110000
//LKED.SYSLMOD DD DSN=API7.COBOL.LOAD,DISP=(SHR,KEEP,KEEP)              00120000
//LKED.SYSIN DD *                                                       00130000
 NAME TP08(R)                                                           00140000
/*                                                                      00150000
//API7TP08 JOB (ACCT#),'ALEXIS',MSGCLASS=H,REGION=4M,                   00010001
//    CLASS=A,MSGLEVEL=(1,1),NOTIFY=&SYSUID,COND=(4,LT)                 00020000
//*                                                                     00030000
