//API7D01  JOB (ACCT#),'ALEXIS',MSGCLASS=H,REGION=4M,                   00010001
...
//COBOL.SYSIN  DD DSN=API7.SOURCE.COBOL(DEMO01),DISP=SHR                00070001
//COBOL.SYSLIB DD DSN=CEE.SCEESAMP,DISP=SHR                             00080000
//*            DD DSN=API2.COB.CPY,DISP=SHR                             00090000
//*                                                                     00100000
//*  ETAPE DE LINKEDIT                                                  00110000
//*                                                                     00120000
//LKED.SYSLMOD DD DSN=API7.COBOL.LOAD,DISP=(SHR,KEEP,KEEP)              00130001
//LKED.SYSIN DD *                                                       00140000
 NAME DEMO01(R)                                                         00150001
/*                                                                      00160000
