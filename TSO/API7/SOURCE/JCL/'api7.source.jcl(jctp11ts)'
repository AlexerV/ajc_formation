//API7CT11 JOB (ACCT#),'ALEXIS',MSGCLASS=H,REGION=4M,                   00010000
...
//COBOL.SYSIN  DD DSN=API7.SOURCE.COBOL(TP11TEST),DISP=SHR              00070000
...
//LKED.SYSIN DD *                                                       00130000
 INCLUDE SYSLIB('TP11ASEQ')                                             00131000
 INCLUDE SYSLIB('TP11')                                                 00132000
 NAME TP11TEST(R)                                                       00140000
/*                                                                      00150000
